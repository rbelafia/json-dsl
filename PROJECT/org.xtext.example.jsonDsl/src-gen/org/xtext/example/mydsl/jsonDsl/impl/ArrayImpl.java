 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.jsonDsl.impl.ArrayImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayImpl extends ConstantImpl implements Array
{
  /**
  ...
  {
    return JsonDslPackage.Literals.ARRAY;
  }
  ...
  public EList<Expression> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<Expression>(Expression.class, this, JsonDslPackage.ARRAY__VALUES);
    }
    return values;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JsonDslPackage.ARRAY__VALUES:
